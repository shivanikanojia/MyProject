...
<link rel="stylesheet" type="text/css" href="CSS/ImageUpoad.css">
					...
					<div class="tab-content">
						<div class="tab-pane active" role="tabpanel" id="step1">
							...
							<div class="form-group">
								...
								<ul class="list-inline pull-right">
									<li><input type="submit" class="btn btn-primary next-step"
										onclick="form.action='DataController';" value="Save"></li>
						...
						<div class="tab-pane" role="tabpanel" id="step2">
							...
							<p id="addMore">
								...
								<input type="text" placeholder="Enter Flat number"
									id="input" name="flatno" class="form-control"><br> 
									
								<label for="Flat Name">Flat Name:</label> 
								<input type="text" placeholder="Enter Flat Name" id="input"
									name="flatname" class="form-control"><br> 
									
								<label for="Area">Area:</label> 
								<input type="text" placeholder="Enter Area" id="input" 
								    name="area" class="form-control"><br>
									
								<label for="Landmark">Landmark:</label> 
								<input type="text" placeholder="Enter Landmark"
									id="input" name="landmark" class="form-control"><br> 
								
								<label for="City">City:</label> 
								<input type="text" placeholder="Enter City" id="input" 
								    name="city" class="form-control"><br>
							
								<label for="State">State:</label> 
								<input type="text" placeholder="Enter State" id="input"
									name="state" class="form-control"><br> 
									
								<label for="Country">Country:</label> 
								<input type="text" placeholder="Enter Country" id="input" 
								    name="country" class="form-control"><br>
								    
								<label for="Pin Code">Pin Code:</label> 
								<input type="text" placeholder="Enter Pin Code" class="form-control"
									id="input" name="pincode" class="from-control"> <br>
						    </p>
							...
							<ul class="list-inline pull-right">
								...
								<li><input type="submit" class="btn btn-primary next-step"
									onclick="form.action='AddressController';" value="Save"></li>
						...
						<div class="tab-pane" role="tabpanel" id="step3">
							...
							<ul class="list-inline pull-right">
								<li><button type="button" class="btn btn-default prev-step">Previous</button></li>
								<li><input type="submit" class="btn btn-primary next-step"
									onclick="form.action='ImageController';" value="Save"></li>
								<li><button type="button"
