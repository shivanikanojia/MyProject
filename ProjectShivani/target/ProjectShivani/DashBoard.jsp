			...
			<div class="w3-third">
				...
				<div class="w3-white w3-text-grey w3-card-4">
					<div class="w3-display-container">
						<img src="https://goo.gl/images/CyEyNQ" style="width: 100%"
							alt="Display Picture">
					...
					<div class="w3-container">
						...
						<p>
							<i class="fa fa-calender fa-fw w3-margin-right w3-large w3-text-teal"></i>${DOB}
						</p>
						<p>
							<i
								class="fa fa-user fa-fw w3-margin-right w3-large w3-text-teal"></i>${Gender}
						</p>
						<p>
							<i
						...
						<p class="w3-large">
							<b><i
								class="fa fa-home fa-fw w3-margin-right w3-text-teal"></i>
							<button style="background-color:39BAA5">Residential Details</button></b>
						</p>
